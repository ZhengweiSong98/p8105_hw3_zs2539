...
![](p8105_hw3_zs2539_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->

In general, min and max temperature have a positive correlation by hex
plot. Also, their binary temperature ranges from -5 - 0 to 17 - 30
degrees Celsius. By the second violin plot, we can see the snowfall
values do not vary apparently by year, and their mean snowfall are all
approximately 25mm.
